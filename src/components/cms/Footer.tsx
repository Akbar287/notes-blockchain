        ...
        <footer className="relative overflow-hidden">
            ...
            >
                <div className="flex flex-col md:flex-row items-center justify-between gap-8 mb-8">
                    ...
                    <motion.div variants={itemVariants} className="flex flex-col items-center md:items-start">
                        ...
                        <p className="text-sm text-slate-600 dark:text-slate-300 text-center md:text-left max-w-xs">
                            Simpan catatan Anda dengan aman di blockchain Ethereum. Terdesentralisasi, transparan, dan abadi.
                        </p>
                    </motion.div>
                ...
                >
                    ...
                    <span>by</span>
                    <motion.a
                        href="https://github.com/akbar287"
                        target="_blank"
                        rel="noopener noreferrer"
                    ...
                    <span>&copy; {currentYear} Notes Blockchain</span>
                </motion.div>
            </motion.div>
        </footer>
    );
