...
import { Connector, useAccount, useConnect, useDisconnect, useConnectors, useSwitchChain } from 'wagmi';
...
// Helper function to add Sepolia Testnet to wallet
async function addSepoliaToWallet() {
...
export default function Navbar() {
    ...
    // Handle switching to Sepolia network
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-sm text-slate-600 dark:text-slate-400 mb-4">
                                        Aplikasi ini menyimpan catatan di jaringan Ethereum Sepolia Testnet. Silakan beralih ke jaringan Sepolia untuk melanjutkan.
                                    </p>
                                    <motion.button
                                        ...
                                        whileTap={{ scale: 0.98 }}
                                    >
                                        {networkRejected ? 'Coba Lagi' : 'Beralih ke Sepolia'}
                                    </motion.button>
                                    {networkRejected && (
                                        <motion.p
